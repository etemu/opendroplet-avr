/*
 Open Droplet OEM
 iilab.org, Alex Shure, Jun Matsushita
 based on Open Energy Monitor/ Adafruit Sound Level Sketch
...
const int LED = 9;                                                   // Moteino onboard LED (instead of 13 for Arduino)

const int LEDpinA = 4;                                                   // LED pin for status output, just a small diode, not a WS28xx RGB LED
const int LEDpinB = 5;                                                   
const int LEDpinC = 6;                                                  
...
void setup() 
{
 ...
 Serial.print(" network group: "); 
  ...
  digitalWrite(LEDpinA, LOW);                                   // Turn LEDs Off 
  digitalWrite(LEDpinB, LOW);                                   // Turn LEDs Off 
  digitalWrite(LEDpinC, LOW);                                   // Turn LEDs Off 
